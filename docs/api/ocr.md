...
Synchronous: it runs on the event loop and blocks speech, hotkey and key callbacks, timers and, on macOS, the event tap until it returns (see the top of this page).
